...
const ComanyForm: React.FC = () => {
  ...
  const phoneNumberPrefixOptions = ["+1 (USA)", "+44 (UK)", "+81 (Japan)", '+91 (IND)'];
      ...
      <Row gutter={16}>
        <Col span={12}>
          <Form.Item
            ...
            rules={[{ required: true }]}
          >
            <Select placeholder="Select a tutorial">
        ...
        <Col span={12}>
          <Form.Item
            ...
            rules={[{ required: true }]}
          >
            <Select placeholder="Select a simulation">
      ...
      <Row gutter={16}>
        <Col span={12}>
          <Form.Item
            ...
            validateDebounce={1000}
            rules={[
              { required: true, message: "Please enter your phone number", max: 10, min: 10 },
              {
                pattern: /^\d+$/,
      ...
      <Row gutter={16}>
        <Col span={12}>
          <Form.Item
            ...
            rules={[{ required: true }]}
          >
            <Select placeholder="Select a company admin">
